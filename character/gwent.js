...
game.import("character", function () {
	return {
			...
			gwjinli: {
				...
				subSkill: {
					jiu: {
						...
						mark: "image",
						intro: {
							content: "结束阶段，随机获得一个正面效果；&个回合后将【先祖麦酒】收入手牌",
						},
						trigger: { player: "phaseEnd" },
						forced: true,
						content() {
			...
			gwmaoxian_old: {
				...
				learn() {
					var list = {
						...
						attack: {
							sha: [1, "你可以将一张手牌当作【杀】使用"],
							huogong: [1, "你可以将一张手牌当作【火攻】使用"],
							aoe: [2, "出牌阶段限一次，你可以弃置两张牌，视为使用一张【南蛮入侵】"],
							shas: [2, "每当你使用一张【杀】，你可以追加一名无视距离的目标"],
						},
						defend: {},
						assist: {},
						control: {},
		...
		translate: {
			...
			gwshuangwu: "霜舞",
			gwshuangwu_info:
				"锁定技，每当你造成一次伤害，你视为对目标使用【刺骨寒霜】；你对处于【刺骨寒霜】的角色造成的伤害+1。",
			gwhuanshuang: "幻霜",
			gwhuanshuang_info: "准备或结束阶段，你可以发现一张铜卡法术并使用之，此牌结算两次。",
			gwjinli: "金醴",
			gwjinli_jiu: "先祖麦酒",
			gwjinli_info: "出牌阶段限一次，你可以弃置一张手牌，并将一张【先祖麦酒】置于一名角色的武将牌上。",
			...
			gwmaoxian_hengsaite_info:
				"视为使用一张【万箭齐发】，每当有一名角色因此受到伤害，你获得一张【杀】，然后结束出牌阶段。",
			...
			gwmaoxian_kuite: "奎特",
			gwmaoxian_kuite_info: "视为对一名手牌数不小于你的角色连续使用2张【决斗】，然后结束出牌阶段。",
			gwmaoxian_haluo: "哈洛",
			gwmaoxian_haluo_info: "对所有体力值全场最少的角色造成1点伤害，然后结束出牌阶段。",
			gwmaoxian_dagong: "达贡",
			gwmaoxian_dagong_info: "视为同时使用【刺骨寒霜】、【蔽日浓雾】和【倾盆大雨】，然后结束出牌阶段。",
			gwmaoxian_gaier: "盖尔",
			...
			gw_lang: "狼",
			gw_lang_info: "在你行动时可当作【酒】使用；回合结束后，从手牌中消失。",
			gwyewu: "叶舞",
			gwyewu_info:
			...
			gwjieyin: "结印",
			gwjieyin_info:
				"出牌阶段，你可以视为使用【瘟疫】、【燕子药水】或【昆恩法印】（不能重复使用同一法术），技能两轮重置一次。",
			zhengjun: "整军",
			zhengjun_info:
			...
			shuijian: "水箭",
			shuijian_info: "准备阶段，你可以弃置一张手牌视为对所有敌方角色使用一张【万箭齐发】。",
			yunhuo: "陨火",
			yunhuo_info:
			...
			chaoyong: "潮涌",
			chaoyong_info: "准备阶段，你可以弃置一张牌，视为对所有敌方角色使用一张【南蛮入侵】或【万箭齐发】。",
		},
	};
});
