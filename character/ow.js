...
game.import("character", function () {
	return {
		...
		characterIntro: {
			...
			ow_baolei:
				"“堡垒”系列在设计之初是被用于维和目的，这一系列的机器单位拥有能够快速在突击和攻城模式之间转换的独特能力。但在“智能危机”期间，该系列却被用来对抗其人类发明者，成为了机器人叛军的中坚力量。随着后来危机的解除，几乎所有的“堡垒”系列机器人都被销毁或拆解。直到今天，“堡垒”依旧是当年那场可怕战争的代名词。但是有一台独特的“堡垒”机器人，在那场战争的决战中严重受损，因此被遗忘了数十年。直到有一天，它被意外地重新激活，它的战斗程序几乎全部受损，取而代之的是对自然世界及其住民的强烈好奇。好奇的“堡垒”于是在这个被战火蹂躏过的世界上，开始了探索和寻找自我价值的旅途。",
			ow_banzang:
