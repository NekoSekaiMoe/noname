...
game.import("card", function () {
	return {
		...
		translate: {
			...
			g_hufu_shan: "符闪",
			g_hufu_jiu: "符酒",
			hufu_info: "你可以将一张玉符当作【杀】、【闪】或【酒】使用或打出。",
			// yihuajiemu:'移花接木',
			...
			yuchanqian: "乾玉蝉",
			yuchanqian_info: "在你行动时可当作【杀】使用；可用于煅造装备；在你使用一张牌后，此牌会随机切换形态。",
			yuchankun: "坤玉蝉",
			yuchankun_info:
				"在你行动时可当作【草药】使用；可用于煅造装备；在你使用一张牌后，此牌会随机切换形态。",
			yuchanzhen: "震玉蝉",
			yuchanzhen_info: "在你行动时可当作【酒】使用；可用于煅造装备；在你使用一张牌后，此牌会随机切换形态。",
			yuchanxun: "巽玉蝉",
			yuchanxun_info: "在你行动时可当作【桃】使用；可用于煅造装备；在你使用一张牌后，此牌会随机切换形态。",
			yuchankan: "坎玉蝉",
			yuchankan_info:
				"在你行动时可当作【神秘果】使用；可用于煅造装备；在你使用一张牌后，此牌会随机切换形态。",
			yuchanli: "离玉蝉",
			yuchanli_info:
				"在你行动时可当作【天仙酒】使用；可用于煅造装备；在你使用一张牌后，此牌会随机切换形态。",
			yuchangen: "艮玉蝉",
			yuchangen_info:
				"在你行动时可当作【封印之蛋】使用；可用于煅造装备；在你使用一张牌后，此牌会随机切换形态。",
			yuchandui: "兑玉蝉",
			yuchandui_info:
				"在你行动时可当作【雪肌冰鲍】使用；可用于煅造装备；在你使用一张牌后，此牌会随机切换形态。",
			yangpijuan: "羊皮卷",
			...
			shuchui: "鼠槌",
			shuchui_info:
				"出牌阶段限一次，你可以指定一名攻击范围内的角色，依次将手牌中的至多3张【杀】对该角色使用，若杀造成了伤害，你摸一张牌。",
			zhiluxiaohu: "指路小狐",
			zhiluxiaohu_info:
				"出牌阶段对自己使用，视为对一名随机敌方角色使用一张【杀】，若此【杀】造成伤害，你摸一张牌。",
			xuejibingbao: "雪肌冰鲍",
			...
			jiguanfeng: "机关蜂",
			jiguanfeng_info:
				"出牌阶段对一名其他角色使用，目标需打出一张【闪】，否则非锁定技失效直到下一回合开始，并受到1点伤害。",
			jiguanyuan: "机关鸢",
			jiguanyuan_info:
			...
			hslingjian_xuanfengzhiren_equip1_info: "每当你用【杀】造成一次伤害，受伤害角色随机弃置一张牌。",
			hslingjian_xuanfengzhiren_equip2_info: "每当你受到【杀】造成的伤害，伤害来源随机弃置一张牌。",
			...
			hslingjian_zhongxinghujia_equip1_info: "每当你用【杀】造成一次伤害，你可以随机装备一件防具牌。",
			hslingjian_zhongxinghujia_equip2_info: "每当你受到【杀】造成的伤害，你可以弃置伤害来源的防具牌。",
			...
			hslingjian_jinjilengdong_equip1_info: "每当你用【杀】造成一次伤害，你可以令目标摸两张牌并翻面。",
			hslingjian_jinjilengdong_equip2_info: "每当你受到【杀】造成的伤害，你可以令伤害来源摸两张牌并翻面。",
			...
			hslingjian_yinmilichang_equip5_info: "当你没有手牌时，你不能成为【杀】或【决斗】的目标。",
			hslingjian_xingtigaizao_duanzao: "移形",
			hslingjian_xingtigaizao_duanzao2: "形",
			hslingjian_xingtigaizao_equip1_info: "每当你用【杀】造成一次伤害，你摸一张牌。",
			hslingjian_xingtigaizao_equip2_info: "每当你受到【杀】造成的伤害，你摸一张牌。",
			...
			hslingjian_shengxiuhaojiao_equip1_info: "有嘲讽的角色不能闪避你的【杀】。",
			hslingjian_shengxiuhaojiao_equip2_info: "有嘲讽的角色不能对你使用【杀】。",
			...
			jiguanyaoshu_info:
				"出牌阶段对距离1以内的一名角色使用，目标随机装备一件装备牌并获得技能〖巧匠〗（每当你于回合外失去装备区内的牌，你获得一个随机零件）。",
			hslingjian: "零件",
			...
			hslingjian_chaofeng_info: "锁定技，与你相邻的角色只能选择你为出【杀】目标。",
			qinglonglingzhu: "青龙灵珠",
			qinglonglingzhu_ab: "灵珠",
			qinglonglingzhu_info: "每当你造成一次属性伤害，你可以获得对方的一张牌。",
			xingjunyan: "星君眼",
			xingjunyan_info: "你的【杀】造成的伤害+1；【杀】对你造成的伤害+1。",
			guiyanfadao: "鬼眼法刀",
			guiyanfadao_bg: "眼",
			guiyanfadao_info: "每当你使用【杀】命中目标，你可以防止伤害，改为令目标失去1点体力。",
			tianxianjiu: "天仙酒",
			tianxianjiu_bg: "仙",
			tianxianjiu_info:
				"出牌阶段对自己使用，你使用的下一张【杀】造成伤害后可以摸两张牌；濒死阶段，对自己使用，回复1点体力。",
			// xiangyuye:'翔羽叶',
			...
			sadengjinhuan: "萨登荆环",
			sadengjinhuan_ab: "荆环",
			sadengjinhuan_info: "当你的【杀】被闪避后，可以进行一次判定，若结果为红色目标需再打出一张【闪】。",
			sadengjinhuan_bg: "荆",
			qipoguyu: "奇魄古玉",
			xujin: "蓄劲",
			xujin2: "蓄劲",
			...
			xixueguizhihuan_info: "锁定技，每当你使用【杀】造成1点伤害，你回复1点体力。",
			xixue: "吸血",
			xixue_info: "锁定技，每当你使用【杀】造成1点伤害，你回复1点体力。",
			zhufangshenshi: "祠符",
			zhufangshenshi_info:
